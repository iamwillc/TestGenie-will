...
function createCustomizePopup() {
    ...
    if (popup.style.display === 'block') {
        ...
        // Show the buttons again when the popup is closed
        document.getElementById('addColumn').style.display = 'block';
        document.getElementById('addRow').style.display = 'block';
    } else {
        popup.style.display = 'block';
        // Hide the Add Column and Add Row buttons
...
function resetTable() {
    ...
    tableContainer.innerHTML = ''; // Remove the current table

    // Reinitialize the table
    initializeTable();

    // Show the Add Column and Add Row buttons again
    document.getElementById('addColumn').style.display = 'inline-block';
    document.getElementById('addRow').style.display = 'inline-block';

    // Optionally, hide the Reset button again if you want it to appear only after Customize is clicked
