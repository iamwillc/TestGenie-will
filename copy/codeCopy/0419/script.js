...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('applyRelationButton').addEventListener('click', function() {
        // // Here you'll handle the logic when the 'Apply' button is clicked
        // // For example, you may want to collect the input and do something with it
        // let userRelationshipInput = document.getElementById('relationReq').value;
        // console.log('Applying relationships:', userRelationshipInput);
...
function resetTable(tableId) {
    ...
    for (let i = 1; i <= 4; i++) {
        ...
        let dropdown = createTypeDropdown(i, tableId); // Assume this function is defined elsewhere
...
function sendRelationshipRequest() {
    ...
    let tableData = readTableData();  // Assuming this function reads data from all tables
    ...
    .then(data => {
        ...
        if (data.result && data.result.rows) {
            // Here you might want to handle the new table or relationships visualization
...
function addResultTable(data) {
    // Create the container for the result table
...
function createAddRelationshipsButton() {
    let addRelationshipsButton = createControlButton('Add Relationships', () => {
        ...
        // Here you can also switch the application mode to "adding relationships"
